...
function transportation(list) {
    ...
    else if (list[1] > 15000) {
        transportation_score += 10;
    }
    else if (list[1] > 10000) {
        transportation_score += 6;
    }
    else if (list[1] > 1000) {
        transportation_score += 4;
...
function get_transportation(transportation_score, max_transportation) {
    return '%.2f'%(float(transportation_score) / max_transportation * 100);
}
